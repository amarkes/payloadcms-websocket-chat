...
import { getUnreadCountsByConversation, getUnreadNotificationsSummary } from '@/lib/chat-notifications'
import ChatAuthScreen from './ChatAuthScreen'
...
export default async function ChatListPage() {
  ...
  const conversationIds = result.docs.map((conversation) => Number(conversation.id)).filter(Number.isFinite)
